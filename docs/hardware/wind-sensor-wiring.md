...
**That was wrong** (buglog bug-038). With only the 8 primary anchors in the
...
That is how both bug-034 and bug-038 happened. `firmware/test/test_vane_decode/`
pins the whole table, including all three bug-038 regressions.
